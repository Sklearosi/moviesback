...
const createUser = async (req, res) => {
  ...
  try {
    ...
    newUser.save();
    await (0, _edge.sendVerificationLink)(email, name, "https://www.google.com");
